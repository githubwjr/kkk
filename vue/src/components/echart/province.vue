	...
	<div class="main-container" id="main-container">
		<div class="main-content">
					<div class="page-content">
						Date: <input class="Wdate" type="text" id="start_time" onClick="WdatePicker()"> 
...
//  this.drawLine(this);
  ...
  methods: {
  	data_init(obj,start_time)
  	{
  		$.ajax({
             url: "http://yii.929.vip/?r=echart/show_d",
...
//	{
//		$.ajax({
//           url: "http://yii.929.vip/?r=echart/show_p",
