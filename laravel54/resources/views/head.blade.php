    ...
    <div class="huya-footer__bd">
        ...
        <div class="huya-footer__nav">
            ...
            <p>
                ...
                <span><img src="{{URL::asset('images/j.gif')}}" alt="">粤公网安备44011302000242号 </span>|
        ...
        <div class="huya-footer__hy-logo">
            ...
            <img src="{{URL::asset('images/hy-logo.png')}}" width="322" height="46"/>

            <a target="_blank" id="_pingansec_bottomimagesmall_brand" href="http://si.trustutn.org/info?sn=950170109026610628628&certType=1"><img src="{{URL::asset('images/brand_bottom_small.jpg')}}"/></a>

            <a href="https://credit.szfw.org/CX20170721035218030329.html" target="_blank"><img src="{{URL::asset('images/sf.png')}}" /></a>

            <a href="https://credit.szfw.org/CX20170721035218020978.html" target="_blank"><img src="{{URL::asset('images/silver.jpg')}}" /></a>
