                ...
                <div class="box-bd">
                    ...
                    <script>
                        $(function(){
                            ...
                            /*模拟从后台获取到的数据*/
                            var sqlJson=[{'src':'images/one.jpeg','date':'2小时前','looked':321},{'src':'images/demo2.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/t1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/p1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/demo2.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/t1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/p1.jpg','writer':'站长素材','date':'2小时前','looked':321}];
                    ...
                    {{--<script type="text/javascript">--}}
                        ...
                        {{--$(function(){--}}
                            ...
                            {{--/*模拟从后台获取到的数据*/--}}
{{--//                            var sqlJson=[{'src':'images/one.jpeg','date':'2小时前','looked':321},{'src':'images/demo2.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/t1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/p1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/demo2.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/t1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'images/p1.jpg','writer':'站长素材','date':'2小时前','looked':321}];--}}
                            {{--var sqlJson=[{'src':'/flow/images/one.jpeg','date':'2小时前','looked':321},{'src':'/flow/images/demo2.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'/flow/images/t1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'/flow/images/p1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'/flow/images/demo2.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'/flow/images/t1.jpg','writer':'站长素材','date':'2小时前','looked':321},{'src':'/flow/images/p1.jpg','writer':'站长素材','date':'2小时前','looked':321}];--}}
                            {{--/*本应该通过ajax从后台请求过来类似sqljson的数据然后，便利，进行填充，这里我们用sqlJson来模拟一下数据*/--}}
                            {{--$(window).scroll(function(){--}}
                                {{--if(!loading.data("on")) return;--}}
                                {{--// 计算所有瀑布流块中距离顶部最大，进而在滚动条滚动时，来进行ajax请求，方法很多这里只列举最简单一种，最易理解一种--}}
                            ...
                            {{--function loadImage(url) {--}}
                                ...
                                {{--};--}}
                            {{--};--}}
                            {{--loadImage('/flow/images/one.jpeg');--}}
                            {{--/*item hover效果*/--}}
                            {{--var rbgB=['#71D3F5','#F0C179','#F28386','#8BD38B'];--}}
                            {{--// $('#waterfull').on('mouseover','.item',function(){--}}
                            {{--// 	var random=Math.floor(Math.random() * 4);--}}
                    ...
                    {{--<div class="content">--}}
                        {{--<!-- 瀑布流样式开始 -->--}}
                        {{--<div class="waterfull clearfloat" id="waterfull" style="margin-left:20px;width:1000px">--}}
                            {{--<ul>--}}
                                {{--<li class="item">--}}
                                    {{--<a href="http://www.datouwang.com/" class="a-img">--}}
                                        {{--<img src="{{URL::asset('flow/images/t8.jpg')}}" alt="">--}}

                                    {{--</a>--}}
                                {{--</li>--}}
                                {{--<li class="item">--}}
                                    {{--<a href="http://www.datouwang.com/" class="a-img">--}}
                                        {{--<img src="{{URL::asset('flow/images/t7.jpg')}}" alt="">--}}

                                    {{--</a>--}}
                                {{--</li>--}}
                                {{--<li class="item">--}}
                                    {{--<a href="http://www.datouwang.com/" class="a-img">--}}
                                        {{--<img src="{{URL::asset('flow/images/t9.jpg')}}" alt="">--}}

                                    {{--</a>--}}
                                {{--</li>--}}
                                {{--<li class="item">--}}
                                    {{--<a href="http://www.datouwang.com/" class="a-img">--}}
                                        {{--<img src="{{URL::asset('flow/images/t3.jpg')}}" alt="">--}}
                                ...
                                {{--<li class="item">--}}
                                    {{--<a href="http://www.datouwang.com/" class="a-img">--}}
                                        {{--<img src="{{URL::asset('flow/images/t6.jpg')}}" alt="">--}}
                                ...
                                {{--<li class="item">--}}
                                    {{--<a href="http://www.datouwang.com/" class="a-img">--}}
                                        {{--<img src="{{URL::asset('flow/images/t4.jpg')}}" alt="">--}}
                                    {{--</a>--}}
                                ...
                                {{--<li class="item">--}}
                                    {{--<a href="http://www.datouwang.com/" class="a-img">--}}
                                        {{--<img src="{{URL::asset('flow/images/t2.jpg')}}" alt="">--}}
